$(document).ready(function () {
  ...
  $("figref").attr('data-gallery', 'imageviewer');
  $("legendref").attr('data-gallery', 'imageviewer');
  const text = "";
  var items = [],
    options = {
      index: $('[data-gallery=imageviewer]').index(),
      resizable: false,
      initMaximized: false,
      headerToolbar: ['addToSearch', 'caption'],
    };

  /*Übergabe des Bildes und des Titels*/
  $('[data-gallery=imageviewer]').each(function () {
    items.push({
  ...
  new ImageViewer(items, options);
  $(".modal-header-title").html('Caption' + ' ' + $(".imageviewer-title").text()),
    $("#modal-legend").html($(".imageviewer-image")[0].attributes[3].nodeValue || ''),

    $('[data-gallery=imageviewer]').mouseenter(function (e) {
      ...
      items.push({
        src: $('img', this).attr('src'),
        text_lst: $('img', this).attr('text_lst'),
        title: titleCase($(this)[0].innerText) || '',
      });

      $(".imageviewer-title")[0].innerHTML = items[0].title,
        $(".imageviewer-image")[0].attributes[1].nodeValue = items[0].src,
        $(".imageviewer-image")[0].attributes[3].nodeValue = items[0].text_lst,
        $(".modal-header-title").html('Caption' + ' ' + $(".imageviewer-title").text()),
        $("#modal-legend").html($(".imageviewer-image")[0].attributes[3].nodeValue || '');
      if ($("#modal-legend")[0].innerText == "") {

      } else {
        arrCaption = $("#modal-legend").html().split(",")
        let text = "";
        arrCaption.forEach(addBtns);

        $("#modal-legend").html(text);
        function addBtns(item) {
          text += "<div class=\"margin\">\n" + `<p>\n ${item} </p>` + "<b>\n<button class=\"addToSearchO tooltip\">\n <span class=\"tooltiptext\">\n Add to document search</span>\n <svg class=\"icon icon-tabler icon-tabler-file-search\" fill=\"none\" height=\"24\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" viewBox=\"0 0 24 24\" width=\"24\" xmlns=\"http://www.w3.org/2000/svg\">\n <path d=\"M0 0h24v24H0z\" fill=\"none\" stroke=\"none\">\n</path>\n <path d=\"M14 3v4a1 1 0 0 0 1 1h4\">\n</path>\n <path d=\"M12 21h-5a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v4.5\">\n </path>\n <circle cx=\"16.5\" cy=\"17.5\" r=\"2.5\">\n</circle>\n <line x1=\"18.5\" x2=\"21\" y1=\"19.5\" y2=\"22\">\n</line>\n </svg>\n</button> <button class=\"addToSearchI\">\n <span class=\"tooltiptext\">\n Add to indocument search</span>\n <svg class=\"icon icon-tabler icon-tabler-file-search\" fill=\"none\" height=\"24\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" viewBox=\"0 0 24 24\" width=\"24\" xmlns=\"http://www.w3.org <path d=\"M0 0h24v24H0z\" fill=\"none\" stroke=\"none\">\n</path>\n <path d=\"M14 3v4a1 1 0 0 0 1 1h4\">\n</path>\n <path d=\"M12 21h-5a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v4.5\">\n </path>\n <circle cx=\"16.5\" cy=\"17.5\" r=\"2.5\">\n</circle>\n <line x1=\"18.5\" x2=\"21\" y1=\"19.5\" y2=\"22\">\n</line>\n </svg>\n</button>\n</b>\n" + "</br>" + "</div>\n"
        }
      }
      $("b button.addToSearchI").click(function (e) {
        e.stopPropagation();
      ...
      $("b button.addToSearchO").click(function (e) {
        e.stopPropagation();
        ...
        $(".headerGrid").slideDown("400", "swing");
      });

      //document.getElementById("modal-legend").innerHTML = document.getElementById("modal-legend").innerHTML.replaceAll(",", "<button>x</button><button>y</button></br>");
      // seems annoying for the user $("#legend").show('fast');
    });

  $(".imageviewer-button.imageviewer-button-caption").on("click", function () {
    $(".modal-header-title").html('Caption' + ' ' + $(".imageviewer-title").text()),
      $("#modal-legend").html($(".imageviewer-image").attr("text_lst") || '');

    if ($("#modal-legend")[0].innerText == "") {

    } else {
      arrCaption = $("#modal-legend").html().split(",").sort()
      let text = "";
      arrCaption.forEach(addBtns);
    ...
    $("b button.addToSearchO").click(function (e) {
      e.stopPropagation();
      var target, newTarget, localRef;
      target = $(this)[0].parentElement.previousSibling.innerText;
      console.log()
      reg = /\d+/;
      newTarget = target.replace(reg, '').trim();
      imgRef.push(newTarget)
  ...
  /* const elems = document.querySelectorAll("legendref");
 
   $("imageviewer img").mouseenter(function (e) {
 
     //declare all variables needed
     var input, filter, pa, h, legend;
     inputs = $("imageviewer img").attr("text_lst").split(",");
     for (let i = 0; inputs.length > i; i++) {
       filter = inputs[i].trim().toUpperCase();
       legend = document.getElementsByTagName('legendref');
       legendRef = legend.innerText;
 
       if (legendRef.toUpperCase().indexOf(filter) > -1) {
         $(legend).css({
           'font-weight': 'bold',
           'color': '#da9046',
           'font-size': '18px'
...
(function (global, factory) {
  ...
  var anim$1 = function (properties, duration, ease, callback, delay) {
    var key, cssValues = {},
      ...
      that = this,
      wrappedCallback, endEvent = D.fx.transitionEnd,
      fired = false;
  ...
  var DEFAULTS = {
    ...
    footerToolbar: ['rotateLeft', 'fullscreen', 'rotateRight'],
    ...
    icons: {
      ...
      addToSearch: "<svg xmlns=\"http://www.w3.org/2000/svg\" class=\"icon icon-tabler icon-tabler-search\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" stroke-width=\"2\" stroke=\"currentColor\" fill=\"none\" stroke-linecap=\"round\" stroke-linejoin=\"round\">\n    <path stroke=\"none\" d=\"M0 0h24v24H0z\" fill=\"none\"></path>\n <circle cx=\"10\" cy=\"10\" r=\"7\"></circle>\n <line x1=\"21\" y1=\"21\" x2=\"15\" y2=\"15\"></line>\n  </svg>",
      caption: "<svg viewBox=\"0 0 16 16\" class=\"svg-inline-icon\">\n         <path fill=\"currentColor\" d=\"M2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2zm3.027 4.002c-.83 0-1.319.642-1.319 1.753v.743c0 1.107.48 1.727 1.319 1.727.69 0 1.138-.435 1.186-1.05H7.36v.114c-.057 1.147-1.028 1.938-2.342 1.938-1.613 0-2.518-1.028-2.518-2.729v-.747C2.5 6.051 3.414 5 5.018 5c1.318 0 2.29.813 2.342 2v.11H6.213c-.048-.638-.505-1.108-1.186-1.108zm6.14 0c-.831 0-1.319.642-1.319 1.753v.743c0 1.107.48 1.727 1.318 1.727.69 0 1.139-.435 1.187-1.05H13.5v.114c-.057 1.147-1.028 1.938-2.342 1.938-1.613 0-2.518-1.028-2.518-2.729v-.747c0-1.7.914-2.751 2.518-2.751 1.318 0 2.29.813 2.342 2v.11h-1.147c-.048-.638-.505-1.108-1.187-1.108z\"></path>\n      </svg>",
      close: "<svg viewBox=\"0 0 24 24\" width=\"24\" height=\"24\" class=\"svg-inline-icon\">\n           <path fill=\"currentColor\" d=\"M13.46,12L19,17.54V19H17.54L12,13.46L6.46,19H5V17.54L10.54,12\n        L5,6.46V5H6.46L12,10.54L17.54,5H19V6.46L13.46,12Z\"></path>\n      </svg>",
  ...
  var ImageViewer = /*#__PURE__*/ function () {
    function ImageViewer(items, options, el) {
    ...
    _createClass(ImageViewer, [{
      ...
      value: function init(items, opts) {
        ...
        this.groupIndex = opts['index']; // Fix: https://github.com/nzbin/imageviewer/issues/7

        PUBLIC_VARS['zIndex'] = PUBLIC_VARS['zIndex'] === 0 ? opts['zIndex'] : PUBLIC_VARS['zIndex']; // Get image src

        var imgSrc = items[this.groupIndex]['src'];
        var text_lst = items[this.groupIndex]['text_lst'];
        this.open();
        this.loadImage(imgSrc); // Draggable & Movable & Resizable
        this.loadCaption(text_lst);
        if (opts.draggable) {
          this.draggable(this.$imageviewer, this.dragHandle, CLASS_NS + '-button');
        }
        ...
        if (opts.resizable) {
          this.resizable(this.$imageviewer, this.$stage, this.$image, opts.modalWidth, opts.modalHeight);
        }
      }
    }, {
      key: "_createBtns",
      value: function _createBtns(toolbar) {
        ...
        var btns = ['addToSearch', 'caption', 'fullscreen', 'rotateLeft', 'rotateRight'];
        var btnsHTML = '';
      ...
      value: function _createTemplate() {
        // ImageViewer base HTML
        var imageviewerHTML = "<div class=\"".concat(NS, "-modal\" tabindex=\"0\">\n        <div class=\"").concat(NS, "-inner\">\n          <div class=\"").concat(NS, "-header\">\n            <div class=\"").concat(NS, "-toolbar ").concat(NS, "-toolbar-header\">\n            ").concat(this._createBtns(this.options.headerToolbar), "\n            </div>\n            ").concat(this._createTitle(), "\n          </div>\n          <div class=\"").concat(NS, "-stage\">\n            <img class=\"").concat(NS, "-image\" src=\"\" alt=\"\" />\n          </div>\n          <div class=\"").concat(NS, "-footer\">\n            <div class=\"").concat(NS, "-toolbar ").concat(NS, "-toolbar-footer\">\n            ").concat(this._createBtns(this.options.footerToolbar), "\n            </div>\n          </div>\n        </div>\n      </div>");
        return imageviewerHTML;
      }
    }, {
      key: "build",
      value: function build() {
        // Create ImageViewer HTML string
        var imageviewerHTML = this._createTemplate(); // Make ImageViewer HTML string to jQuery element


        var $imageviewer = $(imageviewerHTML); // Get all ImageViewer elements

        this.$imageviewer = $imageviewer;
        this.$stage = $imageviewer.find(CLASS_NS + '-stage');
        this.$title = $imageviewer.find(CLASS_NS + '-title');
        this.$image = $imageviewer.find(CLASS_NS + '-image');
        this.$addToSearch = $imageviewer.find(CLASS_NS + '-button-addToSearch');
        this.$caption = $imageviewer.find(CLASS_NS + '-button-caption');
        this.$close = $imageviewer.find(CLASS_NS + '-button-close');
        this.$maximize = $imageviewer.find(CLASS_NS + '-button-maximize');
        this.$minimize = $imageviewer.find(CLASS_NS + '-button-minimize');
        this.$zoomIn = $imageviewer.find(CLASS_NS + '-button-zoomIn');
        this.$zoomOut = $imageviewer.find(CLASS_NS + '-button-zoomOut');
        this.$actualSize = $imageviewer.find(CLASS_NS + '-button-actualSize');
        this.$fullscreen = $imageviewer.find(CLASS_NS + '-button-fullscreen');
        this.$rotateLeft = $imageviewer.find(CLASS_NS + '-button-rotateLeft');
        this.$rotateRight = $imageviewer.find(CLASS_NS + '-button-rotateRight');
        this.$prev = $imageviewer.find(CLASS_NS + '-button-prev');
        this.$next = $imageviewer.find(CLASS_NS + '-button-next'); // Add class before image loaded

        this.$stage.addClass('stage-ready');
        this.$image.addClass('image-ready'); // Reset modal `z-index` of multiple instances

        this.$imageviewer.css('z-index', PUBLIC_VARS['zIndex']);
        ...
        if (!this.options.dragHandle || this.options.dragHandle === CLASS_NS + '-modal') {
          this.dragHandle = this.$imageviewer;
        } else {
          this.dragHandle = this.$imageviewer.find(this.options.dragHandle);
        } // Add ImageViewer to DOM


        $(this.options.appendTo).eq(0).append(this.$imageviewer); // Store the edge value of stage
        ...
        this._modalEdgeValue = {
          horizontal: getCSSValueSum(this.$imageviewer, ['padding-left', 'padding-right', 'border-left-width', 'border-right-width']),
          vertical: getCSSValueSum(this.$imageviewer, ['padding-top', 'padding-bottom', 'border-top-width', 'border-bottom-width'])
        };
      ...
      value: function close() {
        this._triggerHook('beforeClose', this); // Remove ImageViewer instance
      ...
      value: function setModalToCenter() {
        ...
        if (!isBorderBox(this.$imageviewer)) {
        ...
        this.$imageviewer.css(modalInitCSS);
      }
    }, {
      key: "setInitModalPos",
      ...
      value: function setModalSize(img) {
        ...
        if (this.options.initAnimation) {
          this.$imageviewer.animate(modalTransCSS, this.options.animationDuration, 'ease-in-out', function () {
            _this2.setImageSize(img);
          });
        } else {
          this.$imageviewer.css(modalTransCSS);
      ...
      value: function setImageSize(img) {
        ...
        if (!this.imageLoaded) {
          // Loader end
          this.$imageviewer.find(CLASS_NS + '-loader').remove(); // Remove class after image loaded
      ...
      key: "loadCaption",
      value: function loadCaption(text_lst) {
        // Reset image
        this.$image.removeAttr('style').attr('text_lst', '');

        this.$image.attr('text_lst', text_lst);
      }
    },
    {
      key: "loadImage",
      value: function loadImage(imgSrc, fn, err) {
        ...
        this.$imageviewer.append("<div class=\"".concat(NS, "-loader\"></div>")); // Add class before image loaded
        ...
        preloadImage(imgSrc, function (img) {
          ...
          // Loader end
          _this3.$imageviewer.find(CLASS_NS + '-loader').remove(); // Callback of image loading failed
      ...
      value: function jumpTo(index) {
        ...
        this.loadCaption(this.groupData[index].text_lst, function () {
      ...
      value: function maximize() {
        this.$imageviewer.addClass(NS + '-maximized');
        this.$imageviewer.css({
          width: 'auto',
          height: 'auto',
          top: 0,
      ...
      value: function exitMaximize() {
        this.$imageviewer.removeClass(NS + '-maximized');
        this.setModalToCenter();
        this.isMaximized = false;
      }
    }, {
      ...
      value: function _toggleMaximize() {
        if (!this.isMaximized) {
          var originalWidth = parseFloat(this.$imageviewer.width());
          var originalHeight = parseFloat(this.$imageviewer.height());
          ...
          this.modalData = {
            ...
            left: parseFloat(this.$imageviewer.css('left')),
            top: parseFloat(this.$imageviewer.css('top'))
          };
          this.maximize();
        } else {
          this.exitMaximize();
      ...
      key: "addToSearch",
      value: function addToSearch() {
        var imgSrc = this.$image[0].src;
        var imgTitle = this.$title[0].innerText;
      ...
      value: function fullscreen() {
        requestFullscreen(this.$imageviewer[0]);
        this.$imageviewer[0].focus();
      }
    }, {
      key: "_keydown",
      ...
      value: function _addEvents() {
        ...
        this.$addToSearch.off(CLICK_EVENT + EVENT_NS).on(CLICK_EVENT + EVENT_NS, function () {
          _this5.addToSearch();
        });
        ...
        this.$imageviewer.off(KEYDOWN_EVENT + EVENT_NS).on(KEYDOWN_EVENT + EVENT_NS, function (e) {
          _this5._keydown(e);
        });
      }
    }, {
      ...
      value: function _addCustomButtonEvents() {
        ...
        var _loop = function _loop(btnKey) {
          _this6.$imageviewer.find(CLASS_NS + '-button-' + btnKey).off(CLICK_EVENT + EVENT_NS).on(CLICK_EVENT + EVENT_NS, function (e) {
  ...
  /**
   * Add methods to ImageViewer
   */


  $.extend(ImageViewer.prototype, draggable, movable, resizable);
  /**
   * Add ImageViewer to globle
   */
